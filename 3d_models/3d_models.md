...
<div class="content-block">
  <h3><a href="{{ site.baseurl }}/3d_models/18.06.25">Model 2 – F1 2026 Front Wing Designs</a></h3>
  <p>Three front wing models and optimised model designed for F1 2026 regulations using <strong>SolidWorks</strong>. Each design explores different aerodynamic profiles for performance comparison.</p>
  <p>Files are available in <strong>STL</strong> and <strong>STEP</strong> formats.</p>
</div>
...
<div class="content-block">
  <h3><a href="{{ site.baseurl }}/3d_models/03-06-26">Model 4 – 2025 F1 Concept Car Development</a></h3>
  <p>A full vehicle CAD model developed in <strong>SolidWorks</strong>, supporting aerodynamic analysis and iterative CFD optimisation for a 2025 Formula 1 concept car.</p>
</div>
